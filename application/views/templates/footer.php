 ...
 <section class="location text-light py-5">
        <div class="container" data-aos="zoom-in">
            <div class="row">
                <div class="col-lg-4 d-flex align-items-center">
                    ...
                    <div class="ms-2">
                        <h6>ADDRESS</h6>
                        <p>Jl. Ahmad Yani No. 14 Sidoarjo</p>
                    </div>
                </div>
    ...
    <button onclick="topFunction()" id="myBtn">
        <img src="<?php echo base_url() ?>assets/images/up-arrow.png" alt="alternative">
    </button>
    ...
    <script src="<?php echo base_url() ?>assets/js/aos.js"></script><!-- AOS on Animation Scroll -->
    <script src="<?php echo base_url() ?>assets/js/script.js"></script>  <!-- Custom scripts -->
</body>
</html>